...
def connect_to_db(db_name='biv', postgres_pwd='12345678', host=dinamic_host, port='5432'):
    """
...
def create_db(db_name='biv', postgres_pwd='12345678', host=dinamic_host, port='5432') -> None:
...
def create_tables(populate=False, db_name='biv', postgres_pwd='12345678', host=dinamic_host, port='5432') -> None:
